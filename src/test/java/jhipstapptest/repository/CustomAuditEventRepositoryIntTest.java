package jhipstapptest.repository;

import jhipstapptest.JHipstAppTestApp;
import jhipstapptest.config.Constants;
import jhipstapptest.config.audit.AuditEventConverter;
import jhipstapptest.domain.PersistentAuditEvent;
...
import static jhipstapptest.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
